...
class SourceMutationOperators():
    ...
    def NP_mut(self, train_dataset, model, mutation_ratio, STD=0.1):
        ...
        #STD标准差
        random_train_datas = np.random.standard_normal(NP_train_datas.shape) * STD#randn，standard_normal, normal这三个函数都可以返回随机正态分布的数组
        for old_index, new_index in enumerate(permutation):
    ...
    def LAs_mut(self, train_dataset, model, mutated_layer_indices=None):
        ...
        # print(number_of_suitable_spots)
